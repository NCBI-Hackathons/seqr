...
public class FindIndex {
    ...
    private ArrayList<Integer> keyindex; // the key index contain the index for in the index file
    ...
    public static void main(String[] args) {
        ...
        // the convinient way to get the index file - for each findindex object, load the index file
        FindIndex pindex = new FindIndex(args[0]);
        // a more efficient way, read the index file first into MappedByteBuffer, different findindex objects can share one ByteBuffer
